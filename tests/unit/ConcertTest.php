...
class ConcertTest extends TestCase
{
    ...
    function trying_to_purchase_more_tickets_than_remain_throws_an_exception()
    {
        ...
        try {
            $concert->orderTickets($userEmail, 11);
        } catch(NotEnoughTicketsException $e) {
            $order = $concert->orders()->where('email', $userEmail)->first();
    ...
    function cannot_order_tickets_that_have_already_been_purchased()
    {
        ...
        try {
            $concert->orderTickets($userEmail, 3);
        } catch(NotEnoughTicketsException $e) {
            $johnsOrder = $concert->orders()->where('email', $userEmail)->first();
